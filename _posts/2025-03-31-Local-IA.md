...
<form
  method="POST"
  action="https://<VOTRE-STATICMAN-INSTANCE>/v3/entry/github/<USERNAME>/<REPO>/<BRANCH>/comments"
>
  <!-- Le champ slug lie le commentaire à l’article spécifique (souvent l'URL ou un identifiant unique) -->
